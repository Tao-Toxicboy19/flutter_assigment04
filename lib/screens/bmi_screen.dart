...
import 'package:flutter_assigment04/services/bmi_service.dart';
import 'package:flutter_assigment04/widgets/UI/icon_button.dart';
import 'package:flutter_assigment04/widgets/UI/textfield.dart';
                  ...
                  showDialog<String>(
                    ...
                    builder: (BuildContext context) => AlertDialog(
                      title: Align(
                        ...
                        child: Text(
                            'Your BMI ${bmiService.bmi.toStringAsFixed(2)}'),
                      ),
                      actions: <Widget>[
                        Center(
                          child: TextButton(
